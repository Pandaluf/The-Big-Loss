...
public class MicInputBear : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (bear.transform.position.x >= 23.18254 && contRun == 0)
        {
        ...
        if (anim.GetCurrentAnimatorStateInfo(0).IsName("Talking 0"))
        {
            anim.SetBool("Talking", true);
            anim.SetInteger("TalkCount", 1);
            Debug.Log(anim.GetBool("Talking"));
        }
        else
        {
            if (anim.GetCurrentAnimatorStateInfo(0).IsName("Talking 1"))
            {
                anim.SetBool("Talking", true);
                anim.SetInteger("TalkCount", 2);
            }
            else
            {
                if (anim.GetCurrentAnimatorStateInfo(0).IsName("TalkingLoop"))
                {
                    anim.SetBool("Talking", true);
                }
                else
